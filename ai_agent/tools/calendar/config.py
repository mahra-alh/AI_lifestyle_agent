...
DEFAULT_CREDENTIALS_PATH = os.getenv("GOOGLE_CALENDAR_CREDENTIALS_PATH", str(_CONFIG_DIR / "credentials.json"))
...
DEFAULT_TOKEN_PATH = os.getenv("GOOGLE_CALENDAR_TOKEN_PATH", str(_CONFIG_DIR / "token.json"))
DEFAULT_LOG_DIR = os.getenv("GOOGLE_CALENDAR_LOG_DIR", str(Path(__file__).parents[3] / "data" / "logs"))
DEFAULT_MAX_LOG_SIZE_MB = int(os.getenv("GOOGLE_CALENDAR_MAX_LOG_SIZE_MB", "5"))